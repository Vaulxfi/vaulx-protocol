...
export default function DemoVerifyIdEntryPage() {
  return (
    <Suspense fallback={null}>
      <DemoVerifyIdEntryContent />
    </Suspense>
  );
}

function DemoVerifyIdEntryContent() {
  ...
  const nextHref = (() => {
    ...
    return `/demo/borrow/verify-id/redirecting?${qs.toString()}`;
  })();
